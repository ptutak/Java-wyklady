...
public class mainClass {
    public static void main(String[] args) {
        try {
            ...
            InetAddress addr = InetAddress.getByName("jenkov.com"); //zamieniamy nazwę strony na poprawny adres

            SocketAddress address = new InetSocketAddress(addr,80);
            ...
            socketChannel.connect(address);
                 ...
                 *
                 * Następną rzeczą jest zapisanie danych do buferu
                 */
            ...
            String result = new String(buffer.array()).trim();
                ...
                //Dane z bufferu wrzucane są do stringa
